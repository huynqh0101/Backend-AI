# Tạo câu hỏi 2 bước suy luận
# Xây dựng benchmark câu hỏi 2 bước suy luận từ dữ liệu triples
# Benchmark là tập dữ liệu chuẩn hoặc tập kiểm thử tiêu chuẩn dùng để:
#Đánh giá, so sánh hiệu suất hoặc độ chính xác của mô hình, thuật toán hoặc hệ thống.
#Kiểm tra chất lượng và khả năng tổng quát hóa của mô hình học máy (machine learning) hoặc mô hình NLP (xử lý ngôn ngữ tự nhiên).
