# Tạo câu hỏi có nhiều câu trả lời từ các câu hỏi có cùng nội dung
# File này làm sach, làm phông phú dữ liệu benchmark bằng cách gộp các câu hỏi tương tự và tạo ra câu trả lời đa dạng hơn.
